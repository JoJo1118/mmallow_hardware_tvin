...
0x00, 0x3B, 0x46, 0x1F, 0x8C, 0x3C, 0x00, 0x0A, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x01, 0xD3,
0x02, 0x03, 0x35, 0xF0, 0x5A, 0x61, 0x60, 0x10, 0x1F, 0x14, 0x05, 0x13, 0x04, 0x20, 0x22, 0x3C,
0x3E, 0x12, 0x16, 0x03, 0x07, 0x11, 0x15, 0x02, 0x06, 0x01, 0x5F, 0x5D, 0x64, 0x65, 0x66, 0x29,
0x09, 0x07, 0x01, 0x15, 0x07, 0x00, 0x57, 0x06, 0x00, 0x83, 0x01, 0x00, 0x00, 0x67, 0x03, 0x0C,
0x00, 0x10, 0x00, 0x88, 0x3C, 0x02, 0x3A, 0x80, 0xD0, 0x72, 0x38, 0x2D, 0x40, 0x10, 0x2C, 0x45,
...
int hdmi_rx_ctrl_edid_update(void)
{
	...
	if((multi_port_edid_enable)&&(edid_mode==0)){
		...
		hdmirx_wr_top( HDMIRX_TOP_EDID_RAM_OVR0, 0xff | (0x0f<<16));
		hdmirx_wr_top( HDMIRX_TOP_EDID_RAM_OVR0_DATA, 0x7D|0x6D<<8|0x5D<<16);
	}
	//check sum add 0xff
    //hdmirx_wr_top( HDMIRX_TOP_EDID_RAM_OVR0, 0xff | (0x0f<<16));
	//if(value >= 0x30)
