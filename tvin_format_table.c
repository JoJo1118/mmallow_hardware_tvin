...
const char * tvin_sig_fmt_str(enum tvin_sig_fmt_e fmt)
{
	switch (fmt)
	{
		...
		case TVIN_SIG_FMT_VGA_1680X1050P_60HZ_D000:
			...
			break;
		case TVIN_SIG_FMT_VGA_800X600P_85HZ_D062: //120
			return "TVIN_SIG_FMT_VGA_800X600P_85D062";
			break;
...
const struct tvin_format_s tvin_vga_fmt_tbl[TVIN_SIG_FMT_VGA_MAX - TVIN_SIG_FMT_VGA_512X384P_60HZ_D147 + 1] =
{
	...
	{1024,     768,     495 ,        10,    10,       29 ,        10,   1328,    803,     16,     96,    192,       6,       6,   23,    TVIN_SYNC_POL_NEGATIVE, TVIN_SYNC_POL_NEGATIVE, TVIN_SCAN_MODE_PROGRESSIVE,  8000,   0,   0, 1280 }, // TVIN_SIG_FMT_VGA_1024X768P_75D020,
	...
	{1440,     900,    429 ,        10,    10,       34 ,        10,   1904,    934,    80,    152,    232,       3,       6,   25,    TVIN_SYNC_POL_NEGATIVE, TVIN_SYNC_POL_POSITIVE, TVIN_SCAN_MODE_PROGRESSIVE, 10650,   0,   0, 1603 }, // TVIN_SIG_FMT_VGA_1440X900P_59D887,
	...
	{ 800,	   600,    633 ,	10,    10,	 51 ,	     10,   1048,    631,     32,     64,    152,       1,	3,   27,    TVIN_SYNC_POL_NEGATIVE, TVIN_SYNC_POL_NEGATIVE, TVIN_SCAN_MODE_PROGRESSIVE,  5625,	 0,   0, 1129 }, // TVIN_SIG_FMT_VGA_800X600P_85D062,
...
const unsigned char adc_vga_table[TVIN_SIG_FMT_VGA_MAX - TVIN_SIG_FMT_VGA_512X384P_60HZ_D147][ADC_REG_NUM] =
{
	...
	}, // TVIN_SIG_FMT_VGA_1680X1050P_60D000, 
	{
		...
		0x1D, 0x28, 0x02, 0x01, 0x27, 0x00, 0x13, 0x00, 0x00, 0x07, 0x24, 0x22, 0x8f, 0x6F, 0x28, 0x00,
		0xFF, 0x00, 0x28, 0x21, 0x00, 0x00, 0x10, 0x00, 0x22, 0x29, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00
	}, // TVIN_SIG_FMT_VGA_800X600P_85D062,
};
